...
terminal:
    funcs:
        control_funcs:
            print_prompt:
                ldi         r0, T_PROMPT - 0x100 ;---> low 8 bits of prompt for terminal
                ldi         r1, 0b01
                push        r1
                push        r0
                syscall     SYS_PUTS
            ...
            print_error: ;---> error code must be on the stack
                pop         r4
                ldi         r0, T_ERR_TMPLATE - 0x100 ;---> low 8 bits of prompt for terminal
                ldi         r1, 0b01
                push        r1 ;---> hi2
                push        r0 ;---> lo8
                syscall     SYS_PUTS
        ...
        user_funcs:
            ...
            ;---> assumes r4 is argp hi2, r7 is 1, r0 is arg lo8 already
                ...
                push        r3
                push        r2
                syscall     SYS_ASCII_2HEX ;---> (**arg), hex value
                ret
            c:
                syscall     SYS_CLS
                call        [print_prompt]
    ...
    main:
        ...
        .main_loop:
            ...
            .backspace_handler:
                ...
                syscall     SYS_STORE8
                push        r6 
                syscall     SYS_PUTC ;---> echoing backspace character
                jmp         [.main_loop]
